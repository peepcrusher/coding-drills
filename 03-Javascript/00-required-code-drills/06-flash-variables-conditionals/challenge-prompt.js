...
if(budget > rentCost + utilitiesCost + foodCost + transportationCost + computerCost){
    console.log("The total cost of your monthly expenses is " + (rentCost + utilitiesCost + foodCost + transportationCost + computerCost));
}
else{
    alert("Your total cost is " + (rentCost + utilitiesCost + foodCost + transportationCost + computerCost));
}
